                    ...
                    submitFinish ?
                        <>
                            ...
                            <div className='sub-title'>
                                Thank you for submitting your sample information!
                                If you need to get in touch with us regarding your submission,
                        ...
                        <>
                            ...
                            <div className='sub-title'>
                                Follow the steps below and mark sure all details are correct before continuing.
                            </div>
                            <div className="content">
                                ...
                                <div className="each-frame">
                                    {
                                        activeStep === 0 ?
                                            <SampleStep1 formData={{
                                                value: submitterForm, set: setSubmitterForm
                                            }}></SampleStep1> : ""
                                    }
                                    {
                                        activeStep === 1 ?
                                            <SampleStep2 pic={{value: pic, set: setPic}}></SampleStep2> : ""
                                    }
                                    {
                                        activeStep === 2 ?
                                            <SampleStep3 formData={{
                                                value: infoForm, set: setInfoForm
                                            }}></SampleStep3> : ""
                                    }
                                    {
                                        activeStep === 3 ?
                                            <SampleStep4 submitter={submitterForm} pic={pic}
                                                         info={infoForm}></SampleStep4> : ""
                                    }
                                </div>
                            </div>
                            <div className="buttons">
