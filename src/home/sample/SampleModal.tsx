        ...
        <Container>
          {submitFinish ? (
            <>
              ...
              <div className="sub-title">Thank you for submitting your sample information! If you need to get in touch
                with us regarding your submission, please don't hesitate.
              </div>
            ...
            <>
              <div className="title">Submit your sample</div>
              <div className="sub-title">Follow the steps below and mark sure all details are correct before continuing.
              </div>
              <div className="content">
                ...
                <div className="each-frame">
                  ...
                  {activeStep === 3 ?
                    <SampleStep4 submitter={submitterForm} pic={pic} info={infoForm}></SampleStep4> : ""}
                </div>
              </div>
              <div className="buttons">
                {activeStep === 0 ? (
